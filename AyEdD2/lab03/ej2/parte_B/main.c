...
int main(int argc, char *argv[]) {
    ...
    int fun1 = min_temperature(array);

    int proc1[YEARS];
    maximum_temperature(array, proc1);

    int proc2[YEARS];
    maximum_rainfall(array, proc2);

    fprintf(stderr, "la minima temperatura fue de %d:\n",fun1);

    fprintf(stderr, "la maxima temperatura fue:\n");
    array_dump2(proc1);

    fprintf(stderr, "la maxima precipitacion fue:\n");
    array_dump3(proc2);
